            ...
            <div className="px-8 pb-12 space-y-6">
              ...
              <div className="flex flex-col items-center py-0 gap-3  border-t border-slate-50">
                <div className="relative">
                  <div className="w-24 h-24 rounded-full border-[2px] border-white shadow-lg overflow-hidden bg-slate-100">
                    <img 
                ...
                <div className="text-center">
                  ...
                  <p className="text-[11px] font-bold text-slate-500 uppercase tracking-tight">{appointment.petBreed || 'ไม่ระบุสายพันธุ์'}</p>
                </div>
