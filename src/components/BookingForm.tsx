              ...
              {step === 3 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                  ...
                  <button
                    ...
                    onClick={handleNext}
                    className="w-full py-4 bg-pink-500 text-white rounded-2xl font-black active:translate-y-0.5 transition-all disabled:opacity-50 mt-4 mb-8 text-base"
                  >
                    ดูสรุปรายละเอียด
                  </button>
                </motion.div>
              ...
              {step === 4 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6 pb-12">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-pink-500 text-white rounded-2xl font-black active:translate-y-0.5 transition-all flex items-center justify-center gap-2 disabled:opacity-50 text-base"
                  >
