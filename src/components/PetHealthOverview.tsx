        ...
        >
          ...
          <div className="space-y-4 px-1 relative z-10">
            ...
            <div className="relative pt-2 pb-0">
              ...
              <div className="absolute left-[19px] right-[19px] top-[26px] -translate-y-1/2 h-1 bg-slate-100 rounded-full z-0" />
              {/* Active Progress Line - Centered vertically at 27px */}
              <div className="absolute left-[19px] right-[19px] top-[26px] -translate-y-1/2 h-1 z-0 overflow-hidden rounded-full">
                <motion.div 
                  initial={{ width: 0 }}
