    ...
    >
      ...
      <div className="bg-white p-5 rounded-[2rem] shadow-ambient border border-black/5 space-y-4">
        ...
        <div className="relative py-4">
          ...
          <div className="absolute left-[19px] right-[19px] top-[40px] -translate-y-1/2 h-1 bg-slate-100 rounded-full z-0" />
          {/* Active Progress Line - Centered vertically at 30px */}
          <div className="absolute left-[19px] right-[19px] top-[40px] -translate-y-1/2 h-1 z-0 overflow-hidden rounded-full">
            <motion.div 
              initial={{ width: 0 }}
