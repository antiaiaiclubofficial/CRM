    ...
    >
      ...
      <div className="bg-white p-5 rounded-[2rem] shadow-ambient border border-black/5 space-y-4">
        ...
        <div className="relative pt-3 pb-1">
          ...
          <div className="absolute left-[17px] right-[17px] top-[26px] -translate-y-1/8 h-1 bg-slate-100 rounded-full z-0" />
          {/* Active Progress Line - Centered vertically at 26px */}
          <div className="absolute left-[17px] right-[17px] top-[26px] -translate-y-1/8 h-1 z-0 overflow-hidden rounded-full">
            <motion.div 
              initial={{ width: 0 }}
