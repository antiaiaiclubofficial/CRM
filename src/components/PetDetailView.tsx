  ...
  return (
    ...
    >
      ...
      <div className="pt-4 px-6">
        ...
        <div className="bg-[#c28856] rounded-[2.5rem] border-t-8 border-[#c28856] relative shadow-lg border-2 border-[#c28856] shadow-soft"> {/* Changed border-black to border-[#c28856] */}
