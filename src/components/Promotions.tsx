    ...
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-center px-1">
        ...
        <div className="bg-white px-3 py-1 rounded-full border border-slate-100 shadow-sm">
          <span className="text-xs font-bold text-pink-500">มี 4 คูปอง</span>
        </div>
      </div>
          ...
          >
            ...
            <div className="flex-1 p-4 flex flex-col justify-between relative">
              ...
              <div className="flex justify-between items-center">
                ...
                <button className="text-[10px] font-bold bg-slate-100 px-3 py-1 rounded-full text-slate-600 group-hover:bg-pink-500 group-hover:text-white transition-all">
                  เก็บคูปอง
                </button>
              </div>
            </div>
      ...
      <div className="bg-white/40 p-6 rounded-[2.5rem] text-center border-2 border-dashed border-slate-200">
        <p className="text-xs text-slate-400">คุณมีแต้มสะสม <span className="text-pink-500 font-bold">1,250 แต้ม</span><br/>แลกรับคูปองส่วนลดเพิ่มเติมได้ที่เมนู "แลกของรางวัล"</p>
      </div>
    </div>
  );
};
