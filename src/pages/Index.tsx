...
const Index = () => {
  ...
  return (
    <div className="w-full min-h-screen max-w-lg mx-auto bg-[#FFF9F0] relative shadow-2xl flex flex-col font-['Prompt']">
      <header className="px-6 pt-[calc(2rem+env(safe-area-inset-top))] pb-6 flex justify-between items-center shrink-0">
        <div>
      ...
      {/* Floating Navigation Menu positioned above Safari bottom bar */}
      <nav className="fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom))] left-6 right-6 max-w-[calc(theme(maxWidth.lg)-3rem)] mx-auto bg-white/30 backdrop-blur-xl px-4 py-3 flex justify-between items-center rounded-full shadow-2xl z-50 border border-white/40">
